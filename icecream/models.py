...
icecream_db = [
    ...
    {
    'name' : 'Супер-сильное мороженое',
    'description' : ('Сила грома, сила бури, молоко коровье, сливки.'
                    'Откуси кусочек и лети вверх, как супермен'),
    },
    {
    'name' : 'Мороженое для программиста',
    'description' : ('Единички, нули'
                    'И ничего более'),
    },
]
